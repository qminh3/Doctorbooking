                    ...
                    {!item.cancelled && !item.isCompleted && !item.payment && (
                      <>
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center gap-2"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
